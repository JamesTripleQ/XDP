...
public class xdp_ChronoBoostStats extends BaseShipSystemScript {
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        ...
        if (!ship.isPhased()) {
            ...
            totalDurationWarped += Global.getCombatEngine().getElapsedInLastFrame() * Global.getCombatEngine().getTimeMult().getModifiedValue();
            ...
            if (!warping) {
                if (!player) {
                    Global.getSoundPlayer().playSound("system_temporalshell_loop", 1f, 1.15f, ship.getLocation(),
                            new Vector2f());
                }
                warping = true;
            }
