...
package neon.xdp.data.scripts.campaign.submarkets;
...
public class XDP_MotherShipMarket extends OpenMarketPlugin {
    ...
    public void updateCargoPrePlayerInteraction() {
        ...
        if (okToUpdateShipsAndWeapons()) {
            ...
            addWeapons(weapons, weapons, 2, Factions.DERELICT);
            addFighters(fighters, fighters, 1, Factions.DERELICT);

            getCargo().getMothballedShips().clear();

            FactionDoctrineAPI doctrineOverride = Global.getSector().getFaction(Factions.DERELICT).getDoctrine().clone();
            doctrineOverride.setShipSize(2);

            addShips(Factions.DERELICT,
                    200f, // combat
                    0f, // freighter
                    0f, // tanker
                    0f, // transport
            ...
            addHullMods(2, 3 + itemGenRandom.nextInt(3), Factions.DERELICT);
        }
