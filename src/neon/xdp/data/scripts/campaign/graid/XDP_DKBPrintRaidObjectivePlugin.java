package neon.xdp.data.scripts.campaign.graid;
...
public class XDP_DKBPrintRaidObjectivePlugin extends BlueprintGroundRaidObjectivePluginImpl {

	public XDP_DKBPrintRaidObjectivePlugin(MarketAPI market) {
		super(market);
	}
