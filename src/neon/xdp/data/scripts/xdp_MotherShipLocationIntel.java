...
import neon.xdp.data.scripts.xdp_MotherShipHostilityIntel;
...
public class xdp_MotherShipLocationIntel extends BaseIntelPlugin {
    ...
    public void createSmallDescription(TooltipMakerAPI info, float width, float height) {
        ...
        for (SectorEntityToken entity : nexii) {
            ...
            if (starSystem.isInConstellation() && starSystem.getConstellation() != null) {
    ...
    public void advanceImpl(float amount) {
        ...
        if (check.intervalElapsed()) {
            // Check if player has enough fleet points and hostility intel doesn't exist
            if (Global.getSector().getPlayerFleet() != null &&
                    !Global.getSector().getIntelManager().hasIntelOfClass(xdp_MotherShipHostilityIntel.class) &&
            ...
            // Check if hostility intel exists but isn't a transient script
